...
The Hidden Markov Model introduces latent emotional states that evolve over time 
according to a Markov transition process. Observed emotion scores are assumed to be 
